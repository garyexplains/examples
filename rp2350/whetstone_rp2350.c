...
/*
 * Start of whetstone.c source code from
 * https://github.com/nfinit/ansibench/blob/master/whetstone/src/whetstone.c
 * 
 * It has been modified to meet the needs of this program
 * including renaming main() and removing the flag processing etc
 * 
 */
